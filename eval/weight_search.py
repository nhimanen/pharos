...
FST_INTENTS = [
    ...
    ("abstract class for","ABSTRACT"),  ("abstract class that","ABSTRACT"),
    ("base class for",   "ABSTRACT"),   ("superclass for",     "ABSTRACT"),
    ("enum for",         "ENUM"),       ("enum that",          "ENUM"),
    ("record for",       "RECORD"),     ("record that",        "RECORD"),
    ("data class for",   "RECORD"),     ("annotation for",     "ANNOTATION"),
    ("annotation that",  "ANNOTATION"), ("implementation of",  "IMPLEMENTATION"),
