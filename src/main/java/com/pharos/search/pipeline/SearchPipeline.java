...
/**
 * A composable search pipeline: one or more retrievers → optional pre-merge filters → optional merger → zero or more rerankers.
 *
 ...
 *     .premerge(new DiversityReranker(0.5f))   // applied per-retriever list before merge
...
public final class SearchPipeline {
    ...
    public static final class Builder {
         ...
         * The merger and rerankers still apply {@code req.limit()} as the final cap.
